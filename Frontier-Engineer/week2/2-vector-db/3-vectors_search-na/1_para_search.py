...
"""
1_para_search.py:
Implements a lightweight vector search system for long text using TF‑IDF, chunking, and cosine similarity to find the most relevant text segments.  
Demonstrates how classical (non-embedding) methods can still enable efficient semantic-like retrieval for large documents.
