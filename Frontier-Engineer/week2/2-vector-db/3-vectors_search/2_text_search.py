...
"""
2_text_search.py:
Implements a simple TF‑IDF–based vector search system that converts text into numerical vectors and compares them using cosine similarity.  
Demonstrates how to rank documents by similarity to a query without using deep learning embeddings.
